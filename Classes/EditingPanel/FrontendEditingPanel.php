...
class FrontendEditingPanel
{
    ...
    public function editIcons(
        ...
        $colPos = isset($dataArr['colPos']) ? $dataArr['colPos'] : 0;
        ...
        if ($isWholeElement) {
            ...
            $frontendEditingConfiguration = $GLOBALS['TYPO3_CONF_VARS']['EXTENSIONS']['frontend_editing'];
            ...
            if (!$isWrappedWithDropzone) {
                ...
                if (!GeneralUtility::inList(self::$columnsWithContentList, $colPos)) {
                    ...
                    self::$columnsWithContentList .= ','.$colPos;
                }
            }
        }
    ...
    protected function getPluginConfiguration(): array
    {
        ...
        if (isset($configuration['config']['tx_frontendediting'])) {
